...
def reduce_sufficiency_set(set, target, light_states, switch_states, connections_array, connection_types):
    ...
    for action in set:
        ...
        new_lights_one, new_switches_one = switch_discovery.new_states(action, switch_states,
        ...
        # otherwise it could have been luck
            ...
            new_lights_two, new_switches_two = switch_discovery.new_states(action, new_switches_one,
                                                                           connections_array, connection_types)
