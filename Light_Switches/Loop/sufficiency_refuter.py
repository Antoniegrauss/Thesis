...
def reduce_sufficiency_set(set, target, light_states, switch_states, connections_array, connection_types):
    return_set = set
    ...
    for action in set:
        ...
        new_lights_one, new_switches_one = looped_discovery.new_states(action, switch_states,
        ...
        # otherwise it could have been luck
            ...
            new_lights_two, new_switches_two = looped_discovery.new_states(action, new_switches_one,
                                                                           connections_array, connection_types)
...
# TODO: implement increasing sufficiency set
# Changing the variables outside the sufficiency set should not influence the effect
def increase_sufficiency_set(set, target, light_states, switch_states, connections_array, connection_types):
    return -1
