...
def main(n_loop=10, plot=True):
    ...
    for n in range(n_loop + 1):
        ...
        print("Moving from waypoint type a to b: \n", action_type_from_to)
        ...
        if True in state_changes:
            ...
            for state in changed_states:
                ...
                # TODO: rewrite for room navigation (necessity and sufficiency)
                # Add the current switches to the Sufficient set
                # print("state, ", state, " has changed")
